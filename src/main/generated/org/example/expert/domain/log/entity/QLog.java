...
public class QLog extends EntityPathBase<Log> {
    ...
    public final NumberPath<Long> savedManagerId = createNumber("savedManagerId", Long.class);

    public final EnumPath<org.example.expert.domain.log.enums.SavedStatus> status = createEnum("status", org.example.expert.domain.log.enums.SavedStatus.class);
